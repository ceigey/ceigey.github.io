...
function get_slot_changes(definition, $$scope, dirty, fn) {
  return definition[2] && fn ? $$scope.dirty | definition[2](fn(dirty)) : $$scope.dirty;
}
...
},{}],"../node_modules/url-params-parser/url_parser.js":[function(require,module,exports) {
...
},{}],"../node_modules/url-params-parser/index.js":[function(require,module,exports) {
...
},{"./url_parser":"../node_modules/url-params-parser/url_parser.js"}],"../node_modules/svelte/store/index.mjs":[function(require,module,exports) {
"use strict";
...
},{"../internal":"../node_modules/svelte/internal/index.mjs"}],"../node_modules/svelte-router-spa/src/store.js":[function(require,module,exports) {
...
},{"svelte/store":"../node_modules/svelte/store/index.mjs"}],"../node_modules/svelte-router-spa/src/lib/utils.js":[function(require,module,exports) {
/**
...
},{}],"../node_modules/svelte-router-spa/src/router.js":[function(require,module,exports) {
...
},{"url-params-parser":"../node_modules/url-params-parser/index.js","./store":"../node_modules/svelte-router-spa/src/store.js","./lib/utils":"../node_modules/svelte-router-spa/src/lib/utils.js"}],"../node_modules/svelte-router-spa/src/components/route.svelte":[function(require,module,exports) {
"use strict";
...
/* ../node_modules/svelte-router-spa/src/components/route.svelte generated by Svelte v3.16.1 */
const file = "../node_modules/svelte-router-spa/src/components/route.svelte"; // (10:34) 
...
function create_if_block_2(ctx) {
  ...
  const block = {
    c: function create() {
      (0, _internal.create_component)(route.$$.fragment);
    },
    m: function mount(target, anchor) {
      (0, _internal.mount_component)(route, target, anchor);
      current = true;
    },
    p: function update(ctx, dirty) {
      ...
      if (dirty &
      /*currentRoute*/
      1) route_changes.currentRoute =
      /*currentRoute*/
      ctx[0].childRoute;
      if (dirty &
      /*params*/
      2) route_changes.params =
      /*params*/
      ctx[1];
    ...
    i: function intro(local) {
      if (current) return;
      (0, _internal.transition_in)(route.$$.fragment, local);
      current = true;
    },
    o: function outro(local) {
      (0, _internal.transition_out)(route.$$.fragment, local);
      current = false;
    },
    d: function destroy(detaching) {
      (0, _internal.destroy_component)(route, detaching);
    }
  };
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty &
      /*currentRoute*/
      1) switch_instance_changes.currentRoute = { ...
        /*currentRoute*/
        ctx[0],
        component: ""
      };
...
function create_fragment(ctx) {
  ...
  function select_block_type(ctx, dirty) {
    if (
    /*currentRoute*/
    ctx[0].layout) return 0;
    if (
    /*currentRoute*/
    ctx[0].component) return 1;
    if (
    /*currentRoute*/
    ctx[0].childRoute) return 2;
    return -1;
  }
...
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs"}],"../node_modules/svelte/index.mjs":[function(require,module,exports) {
"use strict";
...
var _internal = require("./internal");
},{"./internal":"../node_modules/svelte/internal/index.mjs"}],"../node_modules/svelte-router-spa/src/components/router.svelte":[function(require,module,exports) {
"use strict";
...
/* ../node_modules/svelte-router-spa/src/components/router.svelte generated by Svelte v3.16.1 */
const file = "../node_modules/svelte-router-spa/src/components/router.svelte";

function create_fragment(ctx) {
  let current;
  const route = new _route.default({
    props: {
      currentRoute:
      /*$activeRoute*/
      ctx[0]
...
function instance($$self, $$props, $$invalidate) {
  let $activeRoute;
  (0, _internal.validate_store)(_store.activeRoute, "activeRoute");
  (0, _internal.component_subscribe)($$self, _store.activeRoute, $$value => $$invalidate(0, $activeRoute = $$value));
  let {
    routes = []
  } = $$props;
  let {
  ...
  (0, _svelte.onMount)(function () {
    (0, _router.SpaRouter)(routes, document.location.href, options).activeRoute;
  });
  ...
  $$self.$inject_state = $$props => {
    if ("routes" in $$props) $$invalidate(1, routes = $$props.routes);
    if ("options" in $$props) $$invalidate(2, options = $$props.options);
    if ("$activeRoute" in $$props) _store.activeRoute.set($activeRoute = $$props.$activeRoute);
  };
...
var _default = Router;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","svelte":"../node_modules/svelte/index.mjs","../router":"../node_modules/svelte-router-spa/src/router.js","./route.svelte":"../node_modules/svelte-router-spa/src/components/route.svelte","../store":"../node_modules/svelte-router-spa/src/store.js"}],"../node_modules/svelte-router-spa/src/components/navigate.svelte":[function(require,module,exports) {
"use strict";
...
/* ../node_modules/svelte-router-spa/src/components/navigate.svelte generated by Svelte v3.16.1 */
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      /*to*/
      ctx[0]);
      (0, _internal.attr_dev)(a, "title",
      /*title*/
      ctx[1]);
      (0, _internal.attr_dev)(a, "class",
      /*styles*/
      ctx[2]);
      (0, _internal.toggle_class)(a, "active", (0, _router.routeIsActive)(
      /*to*/
      ctx[0]));
      (0, _internal.add_location)(a, file, 13, 0, 255);
    ...
    p: function update(ctx, [dirty]) {
      ...
      16) {
        ...
        /*$$scope*/
        ctx[4], null), (0, _internal.get_slot_changes)(default_slot_template,
        /*$$scope*/
        ctx[4], dirty, null));
      }
...
class Navigate extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    (0, _internal.init)(this, options, instance, create_fragment, _internal.safe_not_equal, {
      to: 0,
...
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","../router":"../node_modules/svelte-router-spa/src/router.js"}],"../node_modules/svelte-router-spa/src/index.js":[function(require,module,exports) {
...
},{"./router":"../node_modules/svelte-router-spa/src/router.js","./components/route.svelte":"../node_modules/svelte-router-spa/src/components/route.svelte","./components/router.svelte":"../node_modules/svelte-router-spa/src/components/router.svelte","./components/navigate.svelte":"../node_modules/svelte-router-spa/src/components/navigate.svelte"}],"Home.svelte":[function(require,module,exports) {
"use strict";
...
/* Home.svelte generated by Svelte v3.16.1 */
const file = "Home.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      h1.textContent = "Christian Meredith";
      t1 = (0, _internal.text)("\n  under construction");
      (0, _internal.add_location)(h1, file, 5, 2, 55);
      (0, _internal.add_location)(div, file, 4, 0, 47);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
class Home extends _internal.SvelteComponentDev {
  constructor(options) {
    ...
    if (
    /*currentRoute*/
    ctx[0] === undefined && !("currentRoute" in props)) {
      console.warn("<Home> was created without expected prop 'currentRoute'");
    }
  }
...
var _default = Home;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs"}],"Blog.svelte":[function(require,module,exports) {
"use strict";
...
/* Blog.svelte generated by Svelte v3.16.1 */
const file = "Blog.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      div = (0, _internal.element)("div");
      h1 = (0, _internal.element)("h1");
      h1.textContent = "Christian's Blog";
      t1 = (0, _internal.text)("\n  Testing\n  ");
    ...
    p: function update(ctx, [dirty]) {
      ...
      1 && t2_value !== (t2_value =
      /*currentRoute*/
      ctx[0].nameParams + "")) (0, _internal.set_data_dev)(t2, t2_value);
    },
    i: _internal.noop,
    o: _internal.noop,
    d: function destroy(detaching) {
...
class Blog extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    (0, _internal.init)(this, options, instance, create_fragment, _internal.safe_not_equal, {
      currentRoute: 0
    ...
    /*currentRoute*/
    ctx[0] === undefined && !("currentRoute" in props)) {
      console.warn("<Blog> was created without expected prop 'currentRoute'");
    }
  }
...
var _default = Blog;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs"}],"Routes.js":[function(require,module,exports) {
"use strict";
...
var _Home = _interopRequireDefault(require("./Home.svelte"));

var _Blog = _interopRequireDefault(require("./Blog.svelte"));
...
},{"./Home.svelte":"Home.svelte","./Blog.svelte":"Blog.svelte"}],"App.svelte":[function(require,module,exports) {
"use strict";
...
var _svelteRouterSpa = require("svelte-router-spa");

var _Routes = require("./Routes.js");

/* App.svelte generated by Svelte v3.16.1 */
...
function create_fragment(ctx) {
  ...
  let small;
  let current;
  const router = new _svelteRouterSpa.Router({
    props: {
  ...
  const block = {
    c: function create() {
      ...
      small.textContent = "Under construction...";
      (0, _internal.attr_dev)(div0, "class", "main-container bg-color-white rounded-lg");
      (0, _internal.add_location)(div0, file, 6, 2, 156);
      (0, _internal.attr_dev)(div1, "class", "w-full h-full bg-color-yellow-500");
      (0, _internal.add_location)(div1, file, 5, 0, 106);
      (0, _internal.add_location)(small, file, 11, 0, 252);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      ...
      (0, _internal.mount_component)(router, div0, null);
...
var _default = App;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","svelte-router-spa":"../node_modules/svelte-router-spa/src/index.js","./Routes.js":"Routes.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36736" + '/');
