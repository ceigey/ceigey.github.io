...
var app = (function () {
    ...
    /* src/Home.svelte generated by Svelte v3.16.1 */
    ...
    /* src/Blog.svelte generated by Svelte v3.16.1 */
    ...
    function create_fragment$4(ctx) {
    	...
    	let h1;
    	let t1;
    	let t2_value = /*currentRoute*/ ctx[0].nameParams + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("\n  Testing\n  ");
    			t2 = text(t2_value);
    			add_location(h1, file$2, 5, 2, 55);
    			add_location(div, file$2, 4, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*currentRoute*/ 1 && t2_value !== (t2_value = /*currentRoute*/ ctx[0].nameParams + "")) set_data_dev(t2, t2_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "main-container bg-color-white rounded-lg");
    			add_location(div0, file$3, 6, 2, 156);
    			attr_dev(div1, "class", "w-full h-full bg-color-yellow-500");
    			add_location(div1, file$3, 5, 0, 106);
    			add_location(small, file$3, 11, 0, 252);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
